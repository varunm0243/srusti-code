...
//       <ul className="links">
//         <li>
//           {expanded ? <span>Home</span> : <FontAwesomeIcon icon={faHome} />}
//         </li>
//         <li>
//           {expanded ? <span>About</span> : <FontAwesomeIcon icon={faInfoCircle} />}
//         </li>
//         <li>
//           {expanded ? <span>Services</span> : <FontAwesomeIcon icon={faCogs} />}
//         </li>
